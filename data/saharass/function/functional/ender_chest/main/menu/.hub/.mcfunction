# GUI復帰
  ...
  function saharass:functional/ender_chest/main/menu/.hub/scroll with storage temp: PortalChest.Scroll

# スクロールボタン
  loot replace entity @s enderchest.26 loot saharass:menu/portal/scroll_right
  #loot replace entity @s enderchest.22 loot saharass:menu/portal/previous_page
  loot replace entity @s enderchest.18 loot saharass:menu/portal/scroll_left
