...
execute if entity @s[tag=HeatUP] run summon area_effect_cloud ~ ~ ~ {Duration:6,Age:4,potion_contents:{custom_effects:[{id:"hunger",amplifier:79,duration:10,show_particles:0b,show_icon:0b}]}}
