...
data modify storage saharass:temporary Pos.Player set from entity @p[tag=Attacker] Pos
...
execute store result storage saharass:temporary Pos.AEC[0] double 0.003 run scoreboard players get $VectorX VectorCalculation
execute store result storage saharass:temporary Pos.AEC[1] double 0.003 run scoreboard players get $VectorY VectorCalculation
execute store result storage saharass:temporary Pos.AEC[2] double 0.003 run scoreboard players get $VectorZ VectorCalculation
