...
#10m以内の敵にスキルの処理
execute as @e[type=#saharass:enemy,distance=..10,predicate=saharass:onground] at @s run function saharass:skill/all/31/damage with storage saharass:temporary Skill
