...
execute store result storage saharass:temporary Pos.AEC[0] double 0.01 run scoreboard players get $VectorX VectorCalculation
execute store result storage saharass:temporary Pos.AEC[1] double 0.01 run scoreboard players get $VectorY VectorCalculation
execute store result storage saharass:temporary Pos.AEC[2] double 0.01 run scoreboard players get $VectorZ VectorCalculation
