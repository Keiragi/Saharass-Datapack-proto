...
execute unless predicate saharass:in_water run function saharass:skill/all/13/normal/active
execute if predicate saharass:in_water run function saharass:skill/all/13/boost/active
