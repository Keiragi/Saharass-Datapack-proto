...
execute anchored eyes positioned ^ ^ ^0.3 run function saharass:skill/all/7/beam
...
#0.5秒毎に更新判定
execute if score @s Inferno matches 10.. run function saharass:skill/all/7/count
