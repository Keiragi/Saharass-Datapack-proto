...
playsound minecraft:block.note_block.pling player @s ~ ~ ~ 0.5 1
execute as @e[type=#saharass:enemy,tag=Inferno] at @s run function saharass:skill/all/7/fire/damage/low