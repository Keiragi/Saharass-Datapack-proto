...
execute as @a[scores={WaterVail=1..}] at @s run function saharass:skill/all/15/clear
execute as @a[scores={WaterVail=0}] at @s run function saharass:skill/all/16/end
