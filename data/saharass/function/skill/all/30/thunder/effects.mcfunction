...
playsound minecraft:entity.evoker.prepare_summon player @a[distance=..32] ~ ~ ~ 0.5 2 0.5
playsound entity.puffer_fish.death player @a[distance=..32] ~ ~ ~ 0.5 0.15 0.5
#playsound minecraft:entity.firework_rocket.blast player @a[distance=..32] ~ ~ ~ 0.5 0.75 0.2
#playsound minecraft:entity.lightning_bolt.impact player @a[distance=..32] ~ ~ ~ 0.7 1 0.2
playsound item.trident.return player @a[distance=..32] ~ ~ ~ 0.5 1.5 0.5
playsound minecraft:item.totem.use player @a[distance=..32] ~ ~ ~ 0.4 2 0.5