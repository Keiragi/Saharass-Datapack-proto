# 演出
  ...
  $execute anchored eyes positioned ^ ^ ^0.5 run function saharass:skill/all/$(Number)/beam
...
# 0.4秒毎に更新判定
  $execute if score @s Inferno matches 8.. run function saharass:skill/all/$(Number)/count
