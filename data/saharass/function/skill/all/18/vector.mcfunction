...
data modify storage temp: Pos.Player set from entity @p[tag=Poisonor] Pos
...
execute store result storage temp: Pos.AEC[0] double 0.0015 run scoreboard players get $VectorX VectorCalculation
execute store result storage temp: Pos.AEC[1] double 0.0015 run scoreboard players get $VectorY VectorCalculation
execute store result storage temp: Pos.AEC[2] double 0.0015 run scoreboard players get $VectorZ VectorCalculation
