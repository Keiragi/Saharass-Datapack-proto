# セットスキルがインフェルノでなければメインスキル処理
  execute if entity @s[advancements={saharass:item/use_item={Main=true}}] unless predicate saharass:item/set_inferno run function saharass:skill/core/main/active
