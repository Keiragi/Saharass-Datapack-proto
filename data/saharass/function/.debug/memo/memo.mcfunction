...
#oubai
summon minecraft:armor_stand 39.50 11.00 14.50 {Brain: {memories: {}}, HurtByTimestamp: 0, Invulnerable: 1b, FallFlying: 0b, ShowArms: 1b, PortalCooldown: 0, AbsorptionAmount: 0.0f, FallDistance: 0.0f, DisabledSlots: 4144959, DeathTime: 0s, Pose: {RightArm: [333.0f, 0.0f, 0.0f], LeftLeg: [349.0f, 0.0f, 0.0f], Head: [347.0f, 348.0f, 0.0f], LeftArm: [0.0f, 15.0f, 0.0f], RightLeg: [7.0f, 0.0f, 0.0f], Body: [358.0f, 0.0f, 0.0f]}, Invisible: 0b, Motion: [0.0d, -0.0784000015258789d, 0.0d], Small: 1b, Health: 20.0f, Air: 300s, OnGround: 1b, Rotation: [0.0f, 0.0f], HandItems: [{}, {}], Fire: -1s, ArmorItems: [{}, {components: {"minecraft:dyed_color": {rgb: 10981585}}, count: 1, id: "minecraft:leather_leggings"}, {components: {"minecraft:trim": {material: "minecraft:lapis", pattern: "minecraft:vex"}, "minecraft:dyed_color": {rgb: 14204646}}, count: 1, id: "minecraft:leather_chestplate"}, {components: {"minecraft:lore": ['"https://namemc.com/skin/71b762da8ae4d8df"'], "minecraft:profile": {id: [I; 718984754, 939675984, -1880121179, -1155775541], properties: [{name: "textures", value: "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2RiMTRhOWI2NTQxMDhjOTgwMWMxZWZlODI0YTFiNWFhMTBjNGM1MmNjZDk4YzQxOTQ0ZTJkZDg2NWFiZWE0NyJ9fX0="}]}}, count: 1, id: "minecraft:player_head"}], NoBasePlate: 1b, attributes: [{id: "minecraft:armor", base: 0.0d}, {id: "minecraft:movement_speed", base: 0.7d}, {id: "minecraft:armor_toughness", base: 0.0d}], HurtTime: 0s}
summon minecraft:armor_stand 44.50 10.00 18.50 {NoGravity: 1b, Brain: {memories: {}}, HurtByTimestamp: 0, Invulnerable: 1b, FallFlying: 0b, ShowArms: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, FallDistance: 0.0f, DisabledSlots: 4144959, DeathTime: 0s, Pose: {}, Invisible: 1b, Motion: [0.0d, 0.0d, 0.0d], Small: 1b, Health: 20.0f, Air: 300s, OnGround: 0b, Rotation: [-90.0f, 0.0f], HandItems: [{}, {}], Fire: -1s, ArmorItems: [{count: 1, id: "minecraft:netherite_boots"}, {}, {}, {}], NoBasePlate: 1b, attributes: [{id: "minecraft:armor", base: 0.0d}, {id: "minecraft:knockback_resistance", base: 0.0d}, {id: "minecraft:movement_speed", base: 0.7d}, {id: "minecraft:armor_toughness", base: 0.0d}], HurtTime: 0s}
