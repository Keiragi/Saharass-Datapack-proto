...
execute if data entity @s SelectedItem.components.minecraft:custom_data{Number:0} run function saharass:core/inventory/changed/used_item/main with entity @s SelectedItem.components.minecraft:custom_data