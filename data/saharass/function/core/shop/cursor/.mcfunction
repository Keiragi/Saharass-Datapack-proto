...
#所持金が値段より多ければ購入
execute if score @s HaveEmerald >= #Price HaveEmerald run function saharass:core/shop/cursor/buy with storage temp: Item.Trade.components.minecraft:custom_data
