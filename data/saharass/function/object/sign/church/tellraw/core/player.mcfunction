...
execute store result storage temp: Set.Number int 1 run scoreboard players get @s Set_SkillNumber
...
execute if items entity @s weapon.mainhand #saharass:banner_patterns run function saharass:object/sign/church/tellraw/core/edit/main with storage temp: Set
