...
# コンポーネントがあればつける
  execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Ender_Pouch.Item[0].components run function saharass:object/interaction/npc/depositor/return_item/set_components with storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Ender_Pouch.Item[0]
