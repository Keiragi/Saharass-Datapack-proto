...
# インフェルノ選択ならホールドモードに変更
  $execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skill{"Number":"06"} run item modify entity @s weapon.$(which)hand skill/hold
  $execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skill{"Number":"07"} run item modify entity @s weapon.$(which)hand skill/hold
