#>functional/ender_chest/main/menu/dagger/

# GUI復帰
  function functional/ender_chest/reset
  loot replace entity @s enderchest.11 loot item/021
  loot replace entity @s enderchest.12 loot item/022
  loot replace entity @s enderchest.13 loot item/023
