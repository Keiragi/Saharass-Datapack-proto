#DatapackHelperPlusのエラー表示を消すためだけのfunction
...
scoreboard objectives add HealthCalculation dummy
scoreboard objectives add Health health
scoreboard objectives add Flag_Register dummy
scoreboard objectives add Lightning_Damage dummy
scoreboard objectives add SacredFire_Count dummy
scoreboard objectives add Inferno dummy
scoreboard objectives add Inferno_Count dummy
scoreboard objectives add Acrobat dummy
scoreboard objectives add WaterVail dummy
...
scoreboard objectives add Cave dummy
scoreboard objectives add SkillTimer minecraft.custom:minecraft.play_time
