...
give @p oak_sign[block_entity_data={id:"sign",front_text:{has_glowing_text:1b,messages:['{"text":""}','{"text":""}','{"text":"スクロールをもらう","clickEvent":{"action":"run_command","value":"/function minecraft:.debug/get_scroll"}}','{"text":""}']},is_waxed:1b}] 1

summon minecraft:wandering_trader -15.00 1.00 -20.00 {DeathTime: 0s, DespawnDelay: 0, OnGround: 1b, LeftHanded: 0b, AbsorptionAmount: 0.0f, Invulnerable: 1b, Brain: {memories: {}}, Age: 0, HurtByTimestamp: 15317, Rotation: [315.0f, 0.0f], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], HandDropChances: [0.085f, 0.085f], ForcedAge: 0, attributes: [{id: "minecraft:movement_speed", base: 0.0d}], ArmorItems: [{}, {}, {}, {}], Air: 300s, HandItems: [{}, {}], Offers: {Recipes: [{buy: {id: "minecraft:emerald", count: 5}, sell: {id: "minecraft:cherry_sapling", count: 1}, priceMultiplier: 0.05f, maxUses: 8}, {buy: {id: "minecraft:emerald", count: 5}, sell: {id: "minecraft:jungle_sapling", count: 1}, priceMultiplier: 0.05f, maxUses: 8}, {buy: {id: "minecraft:emerald", count: 3}, sell: {id: "minecraft:bubble_coral_block", count: 1}, priceMultiplier: 0.05f, maxUses: 8}, {buy: {id: "minecraft:emerald", count: 1}, sell: {id: "minecraft:torch", count: 1}, priceMultiplier: 0.05f, maxUses: 12}, {buy: {id: "minecraft:emerald", count: 3}, sell: {id: "minecraft:packed_ice", count: 1}, priceMultiplier: 0.05f, maxUses: 6}]}, Inventory: [], FallDistance: 0.0f, Motion: [0.0d, -0.0784000015258789d, 0.0d], PersistenceRequired: 0b, CanPickUpLoot: 0b, FallFlying: 0b, HurtTime: 0s, Health: 20.0f, Fire: -1s, PortalCooldown: 0}
