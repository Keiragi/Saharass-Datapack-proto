...
{"entity":{"id":"$(type)",PersistenceRequired:1b,Health:$(hp)f,\
"attributes":[{"id":"max_health","base":$(hp)},\
{"id":"attack_damage","base":$(damage)}],"Passengers":[{id:"marker",Tags:["enemy"],"data":{"drop":{"loot":"$(loot)","XP":$(XP),"Emerald":$(Emerald)}}}]}},\
