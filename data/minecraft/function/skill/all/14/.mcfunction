...
execute unless predicate flags/in_water run function skill/all/14/normal/active
execute if predicate flags/in_water run function skill/all/14/boost/active
