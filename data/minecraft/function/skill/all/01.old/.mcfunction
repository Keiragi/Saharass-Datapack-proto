...
execute anchored eyes positioned ^ ^ ^ summon marker run function skill/all/01.old/set_fireball_data with storage temp: Rotation

function skill/all/01.old/schedule_fire
