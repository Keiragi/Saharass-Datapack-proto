...
execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=#enemy,dx=0] run function skill/all/01.old/burst with entity @s data
execute unless block ~ ~ ~ #not_solid run function skill/all/01.old/burst with entity @s data
