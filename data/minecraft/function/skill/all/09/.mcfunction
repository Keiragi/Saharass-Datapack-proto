...
# 読み取り専用から移す
  ...
  # 現在HPを入れて1000倍
    ...
    # 演出 + 攻撃判定
      execute rotated ~ 0 positioned ^ ^ ^1.5 run function skill/all/09/fire
      execute rotated ~ 0 positioned ^ ^ ^3.0 run function skill/all/09/fire
      execute rotated ~ 0 positioned ^ ^ ^4.5 run function skill/all/09/fire
