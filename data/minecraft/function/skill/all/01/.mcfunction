...
# 火の玉召喚 + データセット
  execute anchored eyes positioned ^ ^ ^ summon fireball run function skill/all/01/set_fireball_data with storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skill

# 1秒後に消滅
  schedule function skill/all/01/schedule 1s append
