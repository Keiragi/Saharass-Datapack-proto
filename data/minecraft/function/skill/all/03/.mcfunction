...
# 攻撃倍率
  ...
  scoreboard players remove @s HealthCalculation 2

# 倍率を保存 + 攻撃力のマクロ
  execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skill.Heroics int 1 run scoreboard players get @s HealthCalculation
  function skill/all/03/str with storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skill
