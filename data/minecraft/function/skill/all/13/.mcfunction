...
execute unless predicate flags/in_water run function skill/all/13/normal/active
execute if predicate flags/in_water run function skill/all/13/boost/active
