...
execute store result storage temp: Pos.Enemy[0] double -0.00015 run scoreboard players get $VectorX VectorCalculation
execute store result storage temp: Pos.Enemy[1] double -0.00015 run scoreboard players get $VectorY VectorCalculation
execute store result storage temp: Pos.Enemy[2] double -0.00015 run scoreboard players get $VectorZ VectorCalculation
