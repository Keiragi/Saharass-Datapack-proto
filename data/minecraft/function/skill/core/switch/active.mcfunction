...
# モードのチェック
  execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skill{"Number":"06"} run function skill/core/switch/mode/hold/
  execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skill{"Number":"07"} run function skill/core/switch/mode/hold/
  execute \
  ...
  run function skill/core/switch/mode/immediate/
