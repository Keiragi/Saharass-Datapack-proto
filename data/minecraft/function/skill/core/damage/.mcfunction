...
#execute store result score $Strength DamageCalculation run attribute @s attack_damage base get
  execute store result score $Total DamageCalculation run data get entity @s SelectedItem.components.minecraft:attribute_modifiers.modifiers.[{id:"minecraft:weapon_attack_damage"}].amount
